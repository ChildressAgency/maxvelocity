...
acf_add_local_field_group(array(
    ...
    array(
			'key' => 'field_5d3087329231a',
			'label' => esc_html__('Default Blog Post Featured Image', 'maxvelocity'),
			'name' => 'default_blog_post_featured_image',
			'type' => 'image',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
    ...
    array(
			'key' => 'field_5d321a09ae276',
			'label' => esc_html__('Default Review Author Image', 'maxvelocity'),
			'name' => 'default_review_author_image',
			'type' => 'image',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
